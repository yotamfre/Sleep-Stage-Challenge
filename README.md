...
The purpose of the project is to create an ML model that is capable of detecting onset and wakeup time using accelerometer data.
...
- `training.ipynb`
These are all located in the `essential files` folder. You should run all cells in each file in the order of the files shown above.
